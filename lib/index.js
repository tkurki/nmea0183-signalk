...
const { hasValidCRC32 } = require('./crc32')
...
class Parser {
  constructor(
    ...
    opts.onPropertyValues &&
      opts.onPropertyValues('nmea0183sentenceParser', (propertyValues_) => {
  ...
  parse(sentence) {
    ...
    let valid =
      utils.valid(sentence, this.options.validateChecksum) ||
      hasValidCRC32(sentence)
